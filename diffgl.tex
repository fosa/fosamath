...
\begin{tikzpicture}
  \node (1) at (5,2) {Lineare DGL};
  \node (2) at (3,1) {};
  \node (3) at (7,1) {};
  \node (4) at (2,0) {Trenung der Variabeln};
  \node (5) at (4,0) {Charakteristische Gleichung};
  \node (6) at (6,0) {};
  \node (7) at (8,0) {Variation der Konstanten};
  
  \draw [-latex] (1) to node {homogen} (4) ;
  \draw [-latex] (1) to node {inhomogen} (7) ;
  \draw [-latex] (2) to (5) ;
  \draw [-latex] (3) to (6) ;
\end{tikzpicture}
