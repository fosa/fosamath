...
\begin{itemize}
	\item steht senkrecht zur Höhenlinie
	\item zeigt die Richtung des steilsten Anstiegs an (in $xy$-Ebene)
	\item senkrecht zum Gradient ist jene Richtung welche keinen Anstieg erfährt
		(Höhenlinie)
\end{itemize}
