...
Die ganzen Zahlen beinhalten zusätzlich zu den natürlichen Zahlen auch alle 
...
\begin{figure}[h!]
\centering
\includegraphics[width=0.75\textwidth]{../fig/einheitskreis.pdf}
\end{figure}

% \newpage
\subsubsection{Trigonometrie im Dreieck}
\[ \boxed{\sin\alpha=\frac{G}{H}} \quad 
\boxed{\cos\alpha=\frac{A}{H}} \quad 
\boxed{\tan\alpha=\frac{G}{A}} \quad 
\boxed{\cot\alpha=\frac{A}{G}} \]
$H$: Hypotenuse $\qquad$ $A$: Ankathete $\qquad$ $G$: Gegenkathete

\subsubsection{Umkehrfunktionen der trigonometrischen Funktionen}
\[ \boxed{\alpha=\arcsin\frac{G}{H}} \quad 
\boxed{\alpha=\arccos\frac{A}{H}} \quad 
\boxed{\alpha=\arctan\frac{G}{A}} \quad 
\boxed{\alpha=\arccot\frac{A}{G}} \]
...
Kubische Gleichungen können mit den Cardanischen Formeln gelöst werden. \\
...
Wert von $n$ mit der höchsten Potenz (im Zähler!) erweitert. In diesem Fall 
mit $\frac{1}{n^2}$. 
...
Der Audruck $\frac{1}{n^2}$ geht für $n \rightarrow \infty$ gegen $0$. Daraus 
...
Die Regel von L'H\^opital besagt, dass wenn man einen Grenzwert der Form 
...
L'H\^opital angewendet werden (dies kann man so oft wie nötig wiederholen).
...
\textbf{Achtung!} Bei einem Binom der Form $(x-y)^n$ alterniert das Vorzeichen. 
