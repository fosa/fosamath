...
= \underbrace{\int_{x=a}^{b} \underbrace{\int_{y=f_u(x)}^{f_o(x)} f(x,y) ~ dy}
_{\text{Inneres Integral}} ~ dx}_{\text{Äusseres Integral}}} \]
...
_{\text{Inneres Integral}} ~ d\varphi}_{\text{Äusseres Integral}}} \]
